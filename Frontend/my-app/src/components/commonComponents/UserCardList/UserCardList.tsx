...
// //     if (!response.ok) {
// //       throw new Error("שגיאה בשליפת ההזמנות");
// //     }
// //     const data: Order[] = await response.json();
// //     return data;
// //   } catch (error) {
// //     console.error("שגיאה:", error);
// //     return []; // מחזירה מערך ריק במקרה של שגיאה
// //   }
// // };
...
//       {/* Filters */}
//       <div className="bg-white rounded-xl p-4 shadow-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 dir" dir="rtl">
//         <input
//           type="text"
...
//   }}
//   className={`p-2 border border-gray-300 rounded ${
//     selectedGender === "all" ? "opacity-60" : ""
//   }`}
// >
//   <option value="all">בחר/י מגדר</option>
