    ...
    return (
        <div className="signup-page">
            <div className="signup-container">
                <h2>Create your account</h2>
                <form onSubmit={handleSubmit}>
{error && <p className="error">{typeof error === 'string' ? error : 'Registration failed'}</p>}
                    ...
                    <label>Gender</label>
                    <select value={gender ? 'male' : 'female'} onChange={(e) => setGender(e.target.value === 'male')}>
                        <option value="male">Male</option>
                        <option value="female">Female</option>
                    </select>

                    <label>Age Group</label>
                    <select value={ageGroup ?? ''} onChange={(e) => setAgeGroup(e.target.value ? +e.target.value : null)}>
