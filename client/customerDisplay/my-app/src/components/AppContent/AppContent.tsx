...
import { AppBar, Toolbar, Button, Typography, Tab, Tabs, IconButton, Tooltip } from "@mui/material";
                ...
                <Toolbar sx={{ justifyContent: 'space-between', alignItems: 'center', padding: '8px 16px' }}>
                    <Tooltip title="DosFlix">
                        <IconButton onClick={() => navigate('/')} sx={{ color: "#c1dbca" }}>
                            {<img src={logo} alt="DosFlix Logo" style={{ height: 50, borderRadius: '50%' }} />}    </IconButton>
                    </Tooltip>
                    <Tabs
